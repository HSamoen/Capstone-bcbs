...
export default function User() {
  ...
  const [isLoggedIn, setLoggedIn] = useState(localStorage.getItem('volunteerID') ? true : false);
      ...
      <>
        <div style={{padding:"0px 50px"}}>
                ...
                <MDBCol md="12" xl="4">
                  <MDBCard style={{ borderRadius: '15px' }}>
                    <MDBCardBody className="text-center">
                      ...
                      <MDBBtn rounded size="med" onClick={logout}>
                        Logout
                      </MDBBtn >
                    </MDBCardBody>
                  </MDBCard>
          ...
          {volunteerEvents.map((volunteerEvent) => 
            <div key={volunteerEvent.id} className='card-container'>
        ...
        <h5>Please log in to view the Dashboard</h5>
